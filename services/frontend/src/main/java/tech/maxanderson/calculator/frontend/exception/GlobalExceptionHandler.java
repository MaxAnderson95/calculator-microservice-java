package tech.maxanderson.calculator.frontend.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleServiceUnavailableException(ServiceUnavailableException e) {
        log.error("ServiceUnavailableException occurred: {}", e.getMessage(), e);
        return ResponseEntity
    ...
    public ResponseEntity<Map<String, String>> handleCalculatorException(CalculatorException e) {
        log.error("CalculatorException occurred: {}", e.getMessage());
        return ResponseEntity
